...
namespace APIVerve
{
    public class TriviaGeneratorAPIClient
    {
        ...
        public TriviaGeneratorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public TriviaGeneratorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, triviaQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(triviaQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(triviaQueryOptions options)
        {
